...
const ProductList = () => {
    ...
    const oneSendData = useCallback(() => {
        ...
        fetch('https://af3f-178-121-33-21.eu.ngrok.io/', {
            method: 'POST',
            headers: {
